...
let avatarSrc = "images/avatars/schoose_avatar.JPG"; // Avatar par défaut
...
function changeAvatar(avatarFileName) {
    ...
    const newAvatarPath = `images/avatars/${avatarFileName}`;
    fetch(newAvatarPath)
        .then(response => {
            if (response.ok) {
...
function resetGame() {
    ...
    avatarSrc = "images/avatars/choose_avatar.JPG";
